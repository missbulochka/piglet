...
type GRPCConfig struct {
	...
	GRPCTransCliServer string `envconfig:"PIGLET_TRANSACTIONS_SERVER" default:"piglet-transactions"`
	GRPCTransCliPort   string `envconfig:"PIGLET_TRANSACTIONS_PORT" default:"8081"`
}
